...
export default function ScoringMethodology() {
  ...
  return (
    <section className="py-4 px-4 bg-white dark:bg-gray-950">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center gap-2">
            <Info className="h-5 w-5 text-cisa-navy dark:text-blue-300" />
            <span className="font-semibold text-cisa-navy dark:text-blue-300">Scoring Methodology</span>
          </div>
          {isOpen ? (
        ...
        {/* Accordion Content */}
        {isOpen && (
          <div className="mt-2 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            {/* How It Works */}
            <div className="mb-6">
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">How the Score is Calculated</h3>
            ...
            <div className="mb-6">
              <h3 className="font-bold text-gray-900 dark:text-white mb-3">Scoring Factors</h3>
            ...
            {/* Score Thresholds */}
            <div className="mb-6">
              <h3 className="font-bold text-gray-900 dark:text-white mb-3">Score Thresholds</h3>
              <div className="grid grid-cols-3 gap-3">
                <div className="p-3 bg-red-50 dark:bg-red-950/30 border-l-4 border-red-600 rounded">
                  <p className="font-bold text-red-700 dark:text-red-400">1.0 - 2.0</p>
                  <p className="text-sm text-red-600 dark:text-red-500">SEVERE</p>
                </div>
                <div className="p-3 bg-amber-50 dark:bg-amber-950/30 border-l-4 border-amber-500 rounded">
                  ...
                  <p className="text-sm text-amber-600 dark:text-amber-500">ELEVATED</p>
                </div>
                <div className="p-3 bg-green-50 dark:bg-green-950/30 border-l-4 border-green-600 rounded">
                  <p className="font-bold text-green-700 dark:text-green-400">3.1 - 5.0</p>
                  <p className="text-sm text-green-600 dark:text-green-500">NORMAL</p>
                </div>
              </div>
            </div>
            ...
            {/* Data Sources */}
            <div className="mb-6">
              <h3 className="font-bold text-gray-900 dark:text-white mb-3">Sources (11)</h3>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white">Not satisfied with the weights?</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">
